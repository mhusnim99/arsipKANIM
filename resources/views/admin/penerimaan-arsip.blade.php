...
$(function() {
    ...
    $('.btn-terima').click(function(){
        ...
        $.post(`/admin/penerimaan-arsip/${id}/terima`, {_token:'{{ csrf_token() }}'}, function(){
            Swal.fire({
                icon:'success',
                title:'Berhasil',
    ...
    $('.btn-detail').click(function(){
        ...
        $.get(`/admin/penerimaan-arsip/${id}/detail`, function(res){
            let d = res.data;
            $('#detailContent').html(`
                <table class="table table-bordered">
                    <tr><th width="180">Kode Permohonan</th><td>${d.kode_permohonan}</td></tr>
                    <tr><th>Asal Berkas</th><td>${d.asal_berkas}</td></tr>
                    <tr><th>Status</th><td><span class="badge badge-warning">${d.status}</span></td></tr>
                    <tr><th>Tanggal Kirim</th><td>${d.tanggal_kirim}</td></tr>
                </table>
            `);
        });
    });
